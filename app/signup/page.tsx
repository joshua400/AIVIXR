...
export default function SignupPage({
    ...
    return (
        <main className="min-h-screen bg-navy-darkest flex flex-col items-center justify-center p-4 relative overflow-hidden">
            {/* Background Glimmer */}
            <div className="absolute top-1/4 right-1/4 w-[400px] h-[400px] rounded-full bg-accent-purple/10 blur-[100px]" />
            <div className="absolute bottom-1/4 left-1/4 w-[400px] h-[400px] rounded-full bg-accent-blue/10 blur-[100px]" />
