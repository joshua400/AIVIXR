      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <MotionReveal delay={0.1}>
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-24">
            <a href="mailto:ceo@avixr.in" className="group flex items-center justify-center gap-3 px-10 py-5 bg-charcoal text-white text-sm font-bold tracking-widest uppercase hover:bg-accent-gold hover:text-charcoal transition-all duration-300 rounded-full">
              Get Started
